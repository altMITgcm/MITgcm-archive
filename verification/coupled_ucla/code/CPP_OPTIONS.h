C $Header: /u/gcmpack/MITgcm/verification/coupled_ucla/code/Attic/CPP_OPTIONS.h,v 1.1.2.1 2003/01/20 03:05:58 dimitri Exp $
C $Name:  $
...
C o Include/exclude code for coupling to UCLA atmospheric model
#define COUPLED_UCLA

C o CPP flag used for debugging COUPLED_UCLA code
